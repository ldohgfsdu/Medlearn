"""优化extractedKnowledge.ts文件，只保留轻量级数据"""

import json
import re

# 读取文件
with open('g:/MedLearn/mini-program/src/data/extractedKnowledge.ts', 'r', encoding='utf-8') as f:
    content = f.read()
...
# 写入文件
with open('g:/MedLearn/mini-program/src/data/extractedKnowledge.ts', 'w', encoding='utf-8') as f:
    f.write(output)
...
# 检查文件大小
import os
size = os.path.getsize('g:/MedLearn/mini-program/src/data/extractedKnowledge.ts') / 1024
